...
SELECT 
    ...
    -- =====================================================
    -- DATOS DEL CONTACTO DEL CLIENTE (opcional)
    -- =====================================================
    ...
    -- =====================================================
    -- DATOS DEL MÉTODO DE PAGO (de forma_pago)
    -- =====================================================
    mp.id_metodo_pago,
    ...
    -- =====================================================
    -- DATOS DE LA FORMA DE PAGO HABITUAL DEL CLIENTE
    -- =====================================================
    ...
    -- =====================================================
    -- CAMPOS CALCULADOS - NOMBRES COMPLETOS
    -- =====================================================
    ...
    -- Estado del descuento (información legible)
    CASE 
    ...
    -- Indicador de si aplica descuento (simplificado)
    CASE 
        WHEN p.descuento_presupuesto > 0.00 THEN TRUE
        ELSE FALSE
    END AS aplica_descuento_presupuesto,
    
    -- Diferencia entre descuento presupuesto y descuento cliente
