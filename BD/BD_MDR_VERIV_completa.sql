...
/*!50001 CREATE VIEW `v_linea_presupuesto_calculada` AS SELECT 
 ...
 1 AS `permitir_descuentos_articulo`,
 1 AS `id_impuesto_articulo`,
 1 AS `tipo_impuesto_articulo`,
 1 AS `tasa_impuesto_articulo`,
 1 AS `descr_impuesto_articulo`,
 1 AS `activo_impuesto_articulo`,
 1 AS `id_unidad`,
 1 AS `nombre_unidad`,
 1 AS `name_unidad`,
 1 AS `descr_unidad`,
...
/*!50001 CREATE VIEW `vista_articulo_completa` AS SELECT 
 ...
 1 AS `coeficiente_familia`,
 1 AS `observaciones_presupuesto_familia`,
 1 AS `observations_budget_familia`,
 1 AS `orden_obs_familia`,
 1 AS `permite_descuento_familia`,
 1 AS `activo_familia_relacionada`,
 1 AS `tipo_impuesto`,
 1 AS `tasa_impuesto`,
 1 AS `descr_impuesto`,
 1 AS `activo_impuesto_relacionado`,
 1 AS `nombre_unidad`,
 1 AS `name_unidad`,
 1 AS `descr_unidad`,
 1 AS `simbolo_unidad`,
 1 AS `activo_unidad_relacionada`*/;
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2026-01-24 10:15:42
