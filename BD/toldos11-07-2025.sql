...
INSERT INTO `llamadas` VALUES (1,1,'María García','Avenida Secundaria 45, Barcelona','932345678','622345678','mariagarcia@email.com','2023-11-16 16:30:00','Reclamación sobre factura pendiente',12,3,'2025-05-08 12:48:00',1),(2,3,'Manolo','Manises',NULL,NULL,'manolo@email.com','2025-05-21 14:21:00',NULL,27,3,'2025-04-15 12:08:00',0),(4,1,'Luis Rodríguez','Quart de Poblet',NULL,NULL,NULL,NULL,'<p>TYUTYUTYUTYUYT</p>',1,3,'2025-05-09 00:00:00',1),(6,1,'Juan Pérez','Xirivella',NULL,NULL,NULL,'2025-04-10 00:00:00',NULL,4,1,'2025-04-17 13:08:00',1),(10,1,'Alejandro','Quart de Poblet',NULL,NULL,NULL,NULL,'<sub><u><strike><i>ejemplo de texto para ver si las observaciones funcionan correctamente&nbsp;</i></strike></u></sub>',9,1,'2025-04-18 13:08:00',1),(14,2,'Tomás','Patraix',NULL,NULL,NULL,NULL,NULL,19,2,'2025-05-17 00:00:00',0),(16,3,'Lorena','Burjassot',NULL,NULL,NULL,'2025-05-24 14:21:00',NULL,16,1,'2025-04-11 18:56:00',1),(19,3,'Alejandro','Quart de Poblet',NULL,NULL,NULL,'2025-05-05 09:19:00',NULL,12,2,'2025-05-20 10:55:00',1),(20,3,'Luis Rodríguez','Avenida Secundaria 45, Barcelona',NULL,NULL,NULL,NULL,'<p><br></p>',19,2,'2025-05-09 09:21:00',1),(21,2,'Tomás Hernández','Quart de Poblet','32434234234234','23423434234',NULL,'2025-05-15 17:27:00','<p>werwerewrewrwerwer</p>',2,1,'2025-05-14 17:27:00',1),(22,3,'Luis Rodríguez','Avenida Secundaria 45, Barcelona',NULL,NULL,NULL,NULL,'<p><br></p>',2,3,'2025-05-15 13:18:00',1),(23,3,'Alejandro','Quart de Poblet',NULL,NULL,NULL,NULL,'<p><br></p>',2,2,'2025-05-15 13:22:00',1),(24,2,'dfsdfsdf','sdfsdfdsfdsf',NULL,NULL,NULL,NULL,'<p><br></p>',2,3,'2025-05-22 13:06:00',1),(25,3,'`09u08u\'09k¡09l','piyg9uuyh0im¡o,¡pol',NULL,NULL,NULL,'2025-06-05 12:21:00','<p><br></p>',2,1,'2025-05-30 12:34:00',0);
...
INSERT INTO `metodos_contacto` VALUES (1,'Correo Electrónico',1,1,'mail-email-icon-template-black-color-editable-mail-email-icon-symbol-flat-illustration-for-graphic-and-web-design-free-vector.jpg'),(2,'Llamada Telefónica',1,1,'telefonoContacto.png'),(3,'WhatsApp Business',0,1,'whatsappContacto.png'),(38,'EJEMPLO',0,0,'Fhc5481XwAIkIXM_1.jpg');
...
/*!50106 CREATE*/ /*!50117 DEFINER=`alejandro`@`%`*/ /*!50106 EVENT `desactivar_fecha_vacaciones_12` ON SCHEDULE EVERY 1 DAY STARTS '2025-04-03 00:01:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL desactivar_vacaciones_pasadas() */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`alejandro`@`%`*/ /*!50106 EVENT `desactivar_fecha_vacaciones_3` ON SCHEDULE EVERY 1 DAY STARTS '2025-04-03 03:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL desactivar_vacaciones_pasadas() */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`alejandro`@`%`*/ /*!50106 EVENT `desactivar_vacaciones_pasadas` ON SCHEDULE EVERY 12 HOUR STARTS '2025-05-26 09:34:34' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE com_vacaciones
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`alejandro`@`%` PROCEDURE `desactivar_vacaciones_pasadas`()
BEGIN
...
-- Dump completed on 2025-07-11 14:07:22
