-- ============================================================
-- Migración: Añadir destacar_observaciones_pie_presupuesto a vista_presupuesto_completa
-- Fecha: 2026-02-20
-- Descripción: Nuevo campo booleano para controlar si las observaciones de pie
--              se muestran destacadas (caja decorada) o integradas (texto plano) en el PDF
-- ============================================================
