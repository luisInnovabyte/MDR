-- ============================================================
-- Migración: Eliminar filtro activo_presupuesto de vista_presupuesto_completa
-- Fecha: 04 de marzo de 2026
-- Descripción: La vista filtraba con WHERE activo_presupuesto = 1,
--              lo que hacía desaparecer los presupuestos del DataTable al desactivarlos.
--              Se elimina el filtro para que los presupuestos desactivados sigan visibles
--              con el icono ✗ en la columna "Activo".
--              get_presupuestos_disponibles() mantiene su propio WHERE en el modelo.
-- ============================================================
...
LEFT JOIN vista_presupuesto_peso vpp ON pv.id_version_presupuesto = vpp.id_version_presupuesto
