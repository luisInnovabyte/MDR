-- =============================================================================
-- MIGRACIÓN: Fix JOIN vista_presupuesto_completa → vista_presupuesto_peso
-- Fecha   : 2026-02-19
-- Problema: El LEFT JOIN a vista_presupuesto_peso usaba p.id_presupuesto,
--           lo que devuelve una fila por VERSIÓN y genera duplicados en el
--           DataTable de presupuestos cuando hay más de una versión.
-- Solución: Unir por pv.id_version_presupuesto (ya filtrado a version_actual).
-- =============================================================================
...
-- ✅ FIX 2026-02-19: unir por id_version (no por id_presupuesto) para evitar
--    duplicados cuando el presupuesto tiene más de una versión.
