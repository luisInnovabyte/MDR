...
<div class="br-mainpanel">
    ...
    <div class="br-pagetitle">
        ...
        <div>
            <h4>Usuarios</h4>
            <p class="mg-b-0">Tabla para gestión de usuarios</p>
        </div>
    </div><!-- d-flex -->
                ...
                <table id="usuarios_data" class="table display responsive nowrap">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Buscar por email" class="form-control form-control-sm" /></th>
                            <th><input type="text" placeholder="Buscar por rol" class="form-control form-control-sm" /></th>
