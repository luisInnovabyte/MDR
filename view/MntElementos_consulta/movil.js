$(document).ready(function () {
  ...
  if (!document.getElementById("elementos-styles")) {
    ...
    function checkTableScroll() {
        ...
        const table = $('#elementos_data');
        
        if (table.length && wrapper.length) {
            const hasScroll = table.width() > wrapper.width();
            wrapper.toggleClass('has-scroll', hasScroll);
        }
    }
    ...
    /////////////////////////////////////
    // CONFIGURACIÓN DATATABLE RESPONSIVE
    /////////////////////////////////////
    var datatable_elementosConfig = {
        ...
        columns: [
            { name: 'control', data: null, defaultContent: '', className: 'details-control text-center', responsivePriority: 1 },
            { name: 'id_elemento', data: 'id_elemento', visible: false, className: "text-center" },
            { name: 'nombre_articulo', data: 'nombre_articulo', className: "text-center", responsivePriority: 2 },
            { name: 'codigo_elemento', data: 'codigo_elemento', className: "text-center", responsivePriority: 3 },
            { name: 'descripcion_elemento', data: 'descripcion_elemento', className: "text-center", responsivePriority: 6 },
            { name: 'nombre_marca', data: 'nombre_marca', className: "text-center", responsivePriority: 7 },
            { name: 'modelo_elemento', data: 'modelo_elemento', className: "text-center", responsivePriority: 8 },
            { name: 'numero_serie_elemento', data: 'numero_serie_elemento', className: "text-center", responsivePriority: 9 },
            { name: 'descripcion_estado_elemento', data: 'descripcion_estado_elemento', className: "text-center", responsivePriority: 4 },
            { 
                name: 'ubicacion', 
                data: 'nave_elemento',
            ...
            { name: 'activo_elemento', data: 'activo_elemento', className: "text-center", responsivePriority: 5 }
        ],
        columnDefs: [
    ...
    function format(d) {
        ...
        const colClass = isMobile ? 'col-12' : 'col-md-6';

        return `
            <div class="card border-info mb-3 details-card" style="overflow: visible;">
    ...
    // Click en botón expandir detalles
