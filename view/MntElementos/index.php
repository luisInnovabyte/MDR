...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Elementos del Artículo</span>
        </nav>
    </div><!-- br-pageheader -->
    ...
    <div class="br-pagetitle">
        <div class="d-flex align-items-center justify-content-between mb-3">
            <div class="d-flex align-items-center">
                <h4 class="mb-0 me-2">Elementos del Artículo</h4>
        ...
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <div class="d-flex gap-2">
                    <a href="formularioElemento.php?modo=nuevo&id_articulo=<?php echo $_GET['id_articulo'] ?? ''; ?>" class="btn btn-oblong btn-outline-primary flex-shrink-0">
                        <i class="fas fa-plus-circle me-2"></i>Nuevo Elemento
                    </a>
                    <a href="../MntArticulos/index.php" class="btn btn-oblong btn-outline-secondary flex-shrink-0">
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="mntelementos.js"></script>
