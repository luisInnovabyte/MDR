...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Roles</span>
        </nav>
    </div><!-- br-pageheader -->
    ...
    <div class="br-pagetitle">
        ...
        <div>
            <h4>Mantenimiento de Estado de Roles</h4>
            <p class="mg-b-0">Tabla básica para el mantenimiento de roles</p>
        </div>
    </div><!-- d-flex -->
                        ...
                        <h6 class="mg-b-0">
                            <a id="accordion-toggle" 
                               ...
                               style="text-decoration: none;">
                                <i class="fas fa-filter me-2"></i>Filtros de Roles
                            </a>
                        </h6>
                    </div>
                ...
                <table id="roles_data" class="table display responsive nowrap">
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Buscar nombre rol" class="form-control form-control-sm" /></th>
                            <th><input type="text" placeholder="1=Act.,0=Desac." class="form-control form-control-sm" /></th>
    ...
    <?php include_once('mantenimientoRoles.php') ?>
