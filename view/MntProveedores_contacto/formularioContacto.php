    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <a class="breadcrumb-item" href="index.php">Contactos del Proveedor</a>
        ...
        <div class="br-pagetitle">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center">
                    <h4 class="mb-0 me-2" id="page-title">Nuevo Contacto del Proveedor</h4>
                ...
                <!-- Botón de regreso -->
                <a href="index.php?id_proveedor=<?php echo $_GET['id_proveedor'] ?? ''; ?>" class="btn btn-outline-secondary">
                    <i class="fas fa-arrow-left me-2"></i>Volver al listado
                </a>
            </div>

            <!-- Info del proveedor -->
            <div class="mt-3" id="info-proveedor">
                <div class="alert alert-info d-flex align-items-center" role="alert">
                    <i class="bi bi-info-circle me-2"></i>
                    <div>
                        <strong>Proveedor:</strong> <span id="nombre-proveedor">Cargando...</span>
                        <small class="ms-3 text-muted">ID: <span id="id-proveedor"><?php echo $_GET['id_proveedor'] ?? ''; ?></span></small>
                    </div>
                </div>
            </div>
            <br>
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                ...
                <form id="formContacto">
                    <!-- Campos ocultos -->
                    <input type="hidden" name="id_contacto_proveedor" id="id_contacto_proveedor">
                    <input type="hidden" name="id_proveedor" id="id_proveedor" value="<?php echo $_GET['id_proveedor'] ?? ''; ?>">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-12 col-md-6">
                                    <label for="nombre_contacto_proveedor" class="form-label">Nombre: <span class="tx-danger">*</span></label>
                                    <input type="text" class="form-control" name="nombre_contacto_proveedor" id="nombre_contacto_proveedor" maxlength="100" placeholder="Ej: Juan, María, Carlos..." required>
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="apellidos_contacto_proveedor" class="form-label">Apellidos:</label>
                                    <input type="text" class="form-control" name="apellidos_contacto_proveedor" id="apellidos_contacto_proveedor" maxlength="150" placeholder="Ej: García López, Pérez Martín...">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6">
                                    <label for="cargo_contacto_proveedor" class="form-label">Cargo:</label>
                                    <input type="text" class="form-control" name="cargo_contacto_proveedor" id="cargo_contacto_proveedor" maxlength="100" placeholder="Ej: Director Comercial, Técnico de Ventas...">
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="departamento_contacto_proveedor" class="form-label">Departamento:</label>
                                    <input type="text" class="form-control" name="departamento_contacto_proveedor" id="departamento_contacto_proveedor" maxlength="100" placeholder="Ej: Ventas, Administración, Técnico...">
                                    <div class="invalid-feedback small-invalid-feedback">Máximo 100 caracteres</div>
                    ...
                    <div class="card mb-4 border-info">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-12 col-md-6">
                                    <label for="telefono_contacto_proveedor" class="form-label">Teléfono:</label>
                                    <input type="text" class="form-control" name="telefono_contacto_proveedor" id="telefono_contacto_proveedor" maxlength="50" placeholder="Ej: 912345678, +34 91 234 56 78">
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="movil_contacto_proveedor" class="form-label">Móvil:</label>
                                    <input type="text" class="form-control" name="movil_contacto_proveedor" id="movil_contacto_proveedor" maxlength="50" placeholder="Ej: 612345678, +34 612 34 56 78">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6">
                                    <label for="email_contacto_proveedor" class="form-label">Email:</label>
                                    <input type="email" class="form-control" name="email_contacto_proveedor" id="email_contacto_proveedor" maxlength="255" placeholder="Ej: contacto@empresa.com">
                                ...
                                <div class="col-12 col-md-6">
                                    <label for="extension_contacto_proveedor" class="form-label">Extensión:</label>
                                    <input type="text" class="form-control" name="extension_contacto_proveedor" id="extension_contacto_proveedor" maxlength="10" placeholder="Ej: 123, 1001">
                    ...
                    <div class="card mb-4 border-success">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-12">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="principal_contacto_proveedor" id="principal_contacto_proveedor">
                                        <label class="form-check-label" for="principal_contacto_proveedor">
                                            <strong>Contacto Principal</strong>
                                        </label>
                                        <small class="form-text text-muted d-block">Marque si es el contacto principal de este proveedor</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12">
                                    <label for="observaciones_contacto_proveedor" class="form-label">Observaciones:</label>
                                    <textarea class="form-control" name="observaciones_contacto_proveedor" id="observaciones_contacto_proveedor" rows="4" placeholder="Notas adicionales sobre el contacto..."></textarea>
                            ...
                            <div class="row" id="estado_section" style="display: none;">
                                <div class="col-12">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="activo_contacto_proveedor_display" checked disabled>
                                        <label class="form-check-label" for="activo_contacto_proveedor_display">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <a href="index.php?id_proveedor=<?php echo $_GET['id_proveedor'] ?? ''; ?>" class="btn btn-secondary btn-lg">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAyudaFormularioLabel">
                        <i class="fas fa-question-circle me-2"></i>Ayuda - Formulario de Contactos del Proveedor
                    </h5>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <ul class="list-unstyled ms-3">
                                <li><i class="fas fa-star text-warning me-2"></i><strong>Contacto Principal:</strong> Solo puede haber uno por proveedor</li>
