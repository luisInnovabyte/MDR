  ...
  if (!document.getElementById("contactos-styles")) {
    ...
    var datatable_contactosConfig = {
        ...
        language: {
            ...
            emptyTable: "No hay contactos registrados para este proveedor",
        ...
        columnDefs: [
            ...
            // Columna 1: id_contacto_proveedor 
            { targets: "id_contacto_proveedor:name", width: '5%', searchable: false, orderable: false, className: "text-center" },
            // Columna 2: nombre_contacto_proveedor
            { targets: "nombre_contacto_proveedor:name", width: '12%', searchable: true, orderable: true, className: "text-center" },
            // Columna 3: apellidos_contacto_proveedor
            { targets: "apellidos_contacto_proveedor:name", width: '12%', searchable: true, orderable: true, className: "text-center" },
            // Columna 4: cargo_contacto_proveedor
            { targets: "cargo_contacto_proveedor:name", width: '10%', searchable: true, orderable: true, className: "text-center" },
            // Columna 5: departamento_contacto_proveedor
            { targets: "departamento_contacto_proveedor:name", width: '10%', searchable: true, orderable: true, className: "text-center" },
            // Columna 6: telefono_contacto_proveedor
            { targets: "telefono_contacto_proveedor:name", width: '10%', searchable: true, orderable: true, className: "text-center" },
            // Columna 7: movil_contacto_proveedor
            { targets: "movil_contacto_proveedor:name", width: '10%', searchable: true, orderable: true, className: "text-center" },
            // Columna 8: email_contacto_proveedor
            { targets: "email_contacto_proveedor:name", width: '12%', searchable: true, orderable: true, className: "text-center" },
            // Columna 9: principal_contacto_proveedor
            {
                targets: "principal_contacto_proveedor:name", width: '8%', orderable: true, searchable: true, className: "text-center",
                render: function (data, type, row) {
                    if (type === "display") {
                        return row.principal_contacto_proveedor == 1 ? 
                    ...
                    return row.principal_contacto_proveedor;
                }
            },
            // Columna 10: activo_contacto_proveedor
            {
                targets: "activo_contacto_proveedor:name", width: '8%', orderable: true, searchable: true, className: "text-center",
                render: function (data, type, row) {
                    if (type === "display") {
                        return row.activo_contacto_proveedor == 1 ? 
                            '<i class="bi bi-check-circle text-success fa-2x"></i>' : 
                            '<i class="bi bi-x-circle text-danger fa-2x"></i>';
                    }
                    return row.activo_contacto_proveedor;
                }
            },
            ...
            {   
                ...
                render: function (data, type, row) {
                    if (row.activo_contacto_proveedor == 1) {
                        return `<button type="button" class="btn btn-danger btn-sm desacContacto" data-bs-toggle="tooltip-primary" data-placement="top" title="Desactivar" data-original-title="Tooltip on top" 
                             data-id_contacto_proveedor="${row.id_contacto_proveedor}"> 
        ...
        return `
            <div class="card border-primary mb-3" style="overflow: visible;">
                            ...
                            <table class="table table-borderless table-striped table-hover mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="pe-4">
                                            ${d.id_contacto_proveedor || '<span class="text-muted fst-italic">Sin ID</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${(d.nombre_contacto_proveedor + ' ' + (d.apellidos_contacto_proveedor || '')).trim() || '<span class="text-muted fst-italic">Sin nombre</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${d.cargo_contacto_proveedor || '<span class="text-muted fst-italic">Sin cargo</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${d.departamento_contacto_proveedor || '<span class="text-muted fst-italic">Sin departamento</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${d.telefono_contacto_proveedor || '<span class="text-muted fst-italic">Sin teléfono</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${d.movil_contacto_proveedor || '<span class="text-muted fst-italic">Sin móvil</span>'}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-borderless table-striped table-hover mb-0">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="pe-4">
                                            ${d.email_contacto_proveedor ? `<a href="mailto:${d.email_contacto_proveedor}" target="_blank">${d.email_contacto_proveedor}</a>` : '<span class="text-muted fst-italic">Sin email</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${d.extension_contacto_proveedor || '<span class="text-muted fst-italic">Sin extensión</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${d.principal_contacto_proveedor == 1 ? '<span class="badge bg-warning text-dark">Contacto Principal</span>' : '<span class="badge bg-secondary">Contacto Secundario</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4" style="max-width: 300px; word-wrap: break-word; white-space: pre-wrap; overflow-wrap: break-word;">
                                            ${d.observaciones_contacto_proveedor || '<span class="text-muted fst-italic">Sin observaciones</span>'}
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="ps-4 w-40 align-top">
                                        ...
                                        <td class="pe-4">
                                            ${d.created_at_contacto_proveedor ? formatoFechaEuropeo(d.created_at_contacto_proveedor) : '<span class="text-muted fst-italic">Sin fecha</span>'}
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="card-footer bg-transparent border-top-0 text-end">
                    <small class="text-muted">Actualizado: ${d.updated_at_contacto_proveedor ? formatoFechaEuropeo(d.updated_at_contacto_proveedor) : 'Sin fecha de actualización'}</small>
                </div>
            </div>
        `;
    }
    ...
    // Función para cargar información del proveedor
    function cargarInfoProveedor(id_proveedor) {
        $.post("../../controller/proveedor.php?op=mostrar", { id_proveedor: id_proveedor }, function (data) {
            ...
            $('#nombre-proveedor').text('Error al cargar');
        });
    }
    ...
    function desacContacto(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("../../controller/proveedores_contacto.php?op=eliminar", { id_contacto_proveedor: id }, function (data) {
    ...
    $(document).on('click', '.desacContacto', function (event) {
        ...
        let id = $(this).data('id_contacto_proveedor');
        desacContacto(id);
    });
    ...
    function activarContacto(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("../../controller/proveedores_contacto.php?op=activar", { id_contacto_proveedor: id }, function (data) {
                    $table.DataTable().ajax.reload();
                    Swal.fire(
                        'Activado',
    ...
    $(document).on('click', '.editarContacto', function (event) {
        ...
        window.location.href = `formularioContacto.php?modo=editar&id=${id}&id_proveedor=${idProveedor}`;
    });
