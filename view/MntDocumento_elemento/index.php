...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Documentos de Elementos</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Gestión de Documentos de Elementos</h4>
        ...
        <br>
        <!-- <div class="mt-2">
            <p class="mg-b-0">Gestión de documentos asociados a elementos</p>
        </div> -->
    </div><!-- d-flex -->
        ...
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <div class="d-flex gap-2 flex-shrink-0 mt-2 mt-sm-0">
                    <a href="formularioDocumento.php?modo=nuevo" class="btn btn-oblong btn-outline-primary" id="btnNuevoDocumento">
                        ...
                        <tr>
                            ...
                            <th>
                                <select class="form-control form-control-sm" title="Filtrar por privacidad">
                                    ...
                                    <option value="0">Públicos</option>
                                </select>
                            </th>
                            <th></th>
                            <th>
...
<!-- *************************************** -->
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="mntDocumento.js"></script>
