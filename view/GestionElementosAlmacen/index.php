...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        #phase2 .page-wrap { padding-bottom: 100px; }
        ...
        .sel-app:focus { border-color: var(--color-brand); }
        ...
        .inp-date:focus { border-color: var(--color-brand); }
        ...
        .elem-strip .codigo   { font-size: 1rem;  font-weight: 700; }
        .elem-strip .articulo { font-size: .82rem; color: #555;    }
        ...
        /* ── NFC full button ──────────────────────────── */
        .btn-nfc-full { border-radius: 10px !important; margin-bottom: 12px; }
    ...
    <div class="page-wrap">
        ...
        <div class="app-card">
            <div class="app-card-body">
                <div class="app-card-title"><i class="fa fa-nfc-symbol me-1"></i> Escanear NFC</div>
...
<div id="phase2" class="phase">
    <div class="page-wrap">
        ...
        <div class="app-card">
            <div class="app-card-body">
                <div class="app-card-title"><i class="fa fa-circle-info me-1"></i> Información</div>
        ...
        <div class="app-card">
            <div class="app-card-body">
                <div class="app-card-title"><i class="fa fa-pen-to-square me-1"></i> Actualizar</div>
...
<!-- ═══════════════════════ BARRA INFERIOR ═══════════════════════ -->
<div id="bottom-bar">
    <button class="btn-app btn-app-secondary" style="flex:0 0 auto; min-width:120px;" onclick="nuevaBusqueda()">
        <i class="fa fa-arrow-left"></i> Nueva
    </button>
    <button class="btn-app btn-app-success" id="btn-guardar" onclick="guardar()">
