...
<body>
    ...
    <div class="br-mainpanel">
        <div class="br-pageheader">
            <nav class="breadcrumb pd-0 mg-0 tx-12">
                ...
                <span class="breadcrumb-item active">Consulta de Mantenimientos</span>
            </nav>
        </div><!-- br-pageheader -->
        
        <div class="br-pagetitle">
            <div class="d-flex align-items-center">
                <h4 class="mb-0 me-2">Consulta de Mantenimientos</h4>
                <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaMantenimientos" title="Ayuda sobre el módulo">
                    ...
                    <table id="elementos_data" class="table display responsive nowrap">
                        <thead>
                            <tr>
                                ...
                                <th>Fecha Prox.Mantenimiento</th>
                                <th>Activo</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>
                                    <select class="form-control form-control-sm" title="Filtrar por estado mantenimiento">
                                ...
                                <th><input type="text" placeholder="Buscar fecha próximo mantenimiento" class="form-control form-control-sm" /></th>
                                <th>
    ...
    <?php include_once('ayudaConsultaMantenimientos.php') ?>
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="consulta_mantenimiento.js"></script>
