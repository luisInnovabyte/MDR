...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Impuestos</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Mantenimiento de Impuestos</h4>
            <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaImpuestos" title="Ayuda sobre el módulo">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <!-- Botón Nuevo Impuesto -->
                <a href="formularioImpuesto.php?modo=nuevo" class="btn btn-oblong btn-outline-primary flex-shrink-0 mt-2 mt-sm-0">
                    <i class="fas fa-plus-circle me-2"></i>Nuevo Impuesto
                </a>
            </div>
                        ...
                        <h6 class="mg-b-0">
                            <a id="accordion-toggle" 
                               ...
                               style="text-decoration: none;">
                                <i class="fas fa-filter me-2"></i>Filtros de Impuestos
                            </a>
                        </h6>
                    </div> -->
            ...
            <div class="table-wrapper">
                <table id="impuestos_data" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Id impuesto</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Buscar tasa" class="form-control form-control-sm" /></th>
                            <th>
...
<!-- *************************************** -->
    ...
    <?php include_once('ayudaImpuestos.php') ?>
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="mntimpuesto.js"></script>
