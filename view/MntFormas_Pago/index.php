...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Formas de Pago</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Mantenimiento de Formas de Pago</h4>
            <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaFormasPago" title="Ayuda sobre el módulo">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <!-- Botón Nueva Forma de Pago -->
                <a href="formularioFormaPago.php?modo=nuevo" class="btn btn-oblong btn-outline-primary flex-shrink-0 mt-2 mt-sm-0">
                    <i class="fas fa-plus-circle me-2"></i>Nueva Forma de Pago
                </a>
            </div>
            ...
            <div class="table-wrapper">
                <table id="formaspago_data" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Id</th>
                        ...
                        <tr>
                            ...
                            <th>
                                <select class="form-control form-control-sm" title="Filtrar por tipo">
                                    ...
                                    <option value="Pago fraccionado">Pago fraccionado</option>
                                </select>
                            </th>
                            <th>
...
<!-- *************************************** -->
    ...
    <?php include_once('ayudaFormasPago.php') ?>
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="mntformaspago.js"></script>
