...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Marcas</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Mantenimiento de Marcas</h4>
            <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaMarcas" title="Ayuda sobre el módulo">
                <i class="bi bi-question-circle text-primary" style="font-size: 1.3rem;"></i>
            </button>
        </div>
        <br>
        <!-- <div class="mt-2">
            <p class="mg-b-0">Tabla básica para el mantenimiento de marcas</p>
        </div> -->
    </div><!-- d-flex -->
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
                        ...
                        <h6 class="mg-b-0">
                            <a id="accordion-toggle" 
                               ...
                               style="text-decoration: none;">
                                <i class="fas fa-filter me-2"></i>Filtros de Marcas
                            </a>
                        </h6>
                    </div> -->
                                            ...
                                            <div class="status-selector">
                                                ...
                                                <div class="status-option">
                                                    ...
                                                    <label for="filterActive" class="status-label">
                                                        ...
                                                        <span class="status-text">Activas</span>
                                                    </label>
                                                </div>
                                                <div class="status-option">
                                                    ...
                                                    <label for="filterInactive" class="status-label">
                                                        ...
                                                        <span class="status-text">Desactivadas</span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="table-wrapper">
                <table id="marcas_data" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Id marca</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Buscar nombre marca" class="form-control form-control-sm" /></th>
    ...
    <?php include_once('mantenimientoMarcas.php') ?>
...
<!-- *************************************** -->
    ...
    <?php include_once('ayudaMarcas.php') ?>
