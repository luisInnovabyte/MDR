...
<div class="text-center mb-3">
    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#modalAyudaMetodos">
        <i class="bi bi-question-circle-fill mr-2"></i>
        Ver Modal de Ayuda - Métodos
    </button>
</div>

<!-- Modal de Ayuda para Mantenimiento de Métodos -->
<div class="modal fade" id="modalAyudaMetodos" tabindex="-1" role="dialog" aria-labelledby="modalAyudaMetodosLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">

            <!-- Header -->
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title d-flex align-items-center" id="modalAyudaMetodosLabel">
            ...
            <div class="modal-body">
                ...
                <div class="mb-4">
                    <h6 class="text-primary d-flex align-items-center">
                        <i class="bi bi-chat-dots-fill mr-2"></i> ¿Qué es el Mantenimiento de Métodos?
                    </h6>
                    <p class="text-muted">
                        El módulo de mantenimiento de métodos permite gestionar y configurar los diferentes canales de 
                        comunicación disponibles en el sistema. Defina los medios de contacto que su empresa utiliza, 
                        personalice sus iconos y active/desactive canales según las necesidades comerciales y operativas.
                    </p>
                </div>
                    ...
                    <div id="accordionCampos" role="tablist">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseNombre" class="collapse" role="tabpanel" aria-labelledby="headingNombre" data-parent="#accordionCampos">
                                <div class="card-body">
                                    <strong>Campo obligatorio.</strong> Nombre descriptivo del método de contacto.
                                    <br><strong>Ejemplos:</strong>
                                    <ul class="mt-2 mb-2">
                                        <li>Correo Electrónico</li>
                                        <li>Llamada Telefónica</li>
                                        <li>WhatsApp Business</li>
                                        <li>Presencia en tienda</li>
                                    </ul>
                        ...
                        <!-- Imagen -->
                        <div class="card">
                            <div class="card-header" role="tab" id="headingImagen">
                                <h5 class="mb-0">
                                    <a class="collapsed d-flex align-items-center" data-toggle="collapse" href="#collapseImagen" aria-expanded="false" aria-controls="collapseImagen">
                                        <i class="bi bi-image-fill mr-2"></i> Imagen
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseImagen" class="collapse" role="tabpanel" aria-labelledby="headingImagen" data-parent="#accordionCampos">
                                <div class="card-body">
                                    <strong>Campo opcional.</strong> Icono o imagen representativa del método de contacto.
                                    <br><strong>Iconos disponibles en el sistema:</strong>
                                    <ul class="mt-2 mb-2">
                                        <li>📧 <strong>Correo Electrónico:</strong> Icono de sobre/email</li>
                                        <li>📞 <strong>Llamada Telefónica:</strong> Icono de teléfono verde con ondas</li>
                                        <li>💬 <strong>WhatsApp Business:</strong> Logo de WhatsApp verde</li>
                                        <li>👤 <strong>Presencia en tienda:</strong> Icono de persona</li>
                                    </ul>
                                    <strong>Uso:</strong> Identificación visual rápida en tablas y reportes
                                    <br><strong>Formatos aceptados:</strong> PNG, JPG, SVG (recomendado)
                                    <br><strong>Dimensiones recomendadas:</strong> 32x32 píxeles o 64x64 píxeles
                                    <br><strong>Beneficio:</strong> Mejora la usabilidad con reconocimiento visual instantáneo
                                </div>
                            </div>
                        </div>
