  ...
  if (!document.getElementById("contactos-styles")) {
    ...
    var datatable_contactosConfig = {
        ...
        columns: [
            ...
            { name: 'nombre_contacto_cliente', data: 'nombre_contacto_cliente', className: "text-center align-middle" }, // Columna 2: NOMBRE
            { name: 'apellidos_contacto_cliente', data: 'apellidos_contacto_cliente', className: "text-center align-middle" }, // Columna 3: APELLIDOS
            { name: 'cargo_contacto_cliente', data: 'cargo_contacto_cliente', className: "text-center align-middle" }, // Columna 4: CARGO
            { name: 'departamento_contacto_cliente', data: 'departamento_contacto_cliente', className: "text-center align-middle" }, // Columna 5: DEPARTAMENTO
            { name: 'telefono_contacto_cliente', data: 'telefono_contacto_cliente', className: "text-center align-middle" }, // Columna 6: TELEFONO
            { name: 'movil_contacto_cliente', data: 'movil_contacto_cliente', className: "text-center align-middle" }, // Columna 7: MOVIL
            { name: 'email_contacto_cliente', data: 'email_contacto_cliente', className: "text-center align-middle" }, // Columna 8: EMAIL
            { name: 'principal_contacto_cliente', data: 'principal_contacto_cliente', className: "text-center align-middle" }, // Columna 9: PRINCIPAL
            { name: 'activo_contacto_cliente', data: 'activo_contacto_cliente', className: "text-center align-middle" }, // Columna 10: ESTADO
