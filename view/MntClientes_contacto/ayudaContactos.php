<!-- Modal de Ayuda para Contactos del Cliente -->
        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="modalAyudaContactosLabel">
                    <i class="fas fa-question-circle me-2"></i>Ayuda - Gestión de Contactos del Cliente
                </h5>
                        ...
                        <div class="card border-0">
                            <div class="card-header bg-light">
                                <h6 class="text-primary mb-0">
                                    <i class="fas fa-info-circle me-2"></i>¿Qué son los Contactos del Cliente?
                                </h6>
                            </div>
                            <div class="card-body">
                                <p class="mb-3">
                                    Los <strong>contactos del cliente</strong> son las personas específicas dentro de la empresa cliente 
                                ...
                                <div class="alert alert-info">
                                    ...
                                    personas según su función: compras, recepción, facturación, etc.
                                </div>
                                ...
                                <p>
                                    Cada cliente puede tener <strong>un único contacto marcado como "Principal"</strong>. 
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="small">Crea un nuevo contacto para el cliente actual.</p>
                                        ...
                                        <div class="alert alert-success">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li class="mb-2">
                                                    ...
                                                    Registra contactos específicos por área: Compras, Recepción, Administración
                                                </li>
                                                <li class="mb-2">
                                                    <i class="fas fa-check text-success me-2"></i>
