...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Proveedores</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Mantenimiento de Proveedores</h4>
            <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaProveedores" title="Ayuda sobre el módulo">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <a href="formularioProveedor.php?modo=nuevo" class="btn btn-oblong btn-outline-primary flex-shrink-0 mt-2 mt-sm-0">
            ...
            <div class="table-wrapper">
                <table id="proveedores_data" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Id proveedor</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Buscar nombre proveedor" class="form-control form-control-sm" /></th>
    ...
    <?php include_once('ayudaProveedores.php') ?>
