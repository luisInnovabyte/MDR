$(document).ready(function () {
    ...
    function desacFamilia(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("../../controller/familia_unidad.php?op=eliminar", { id_familia: id }, function (data) {
    ...
    function activarFamilia(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.post("../../controller/familia_unidad.php?op=activar", { id_familia: id }, function (data) {
