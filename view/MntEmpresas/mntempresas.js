$(document).ready(function () {
    ...
    var datatable_empresasConfig = {
        ...
        columns: [
            ...
            { name: 'codigo_empresa', data: 'codigo_empresa', className: "text-center" },
            { name: 'nombre_empresa', data: 'nombre_empresa', className: "text-center" },
            { name: 'nif_empresa', data: 'nif_empresa', className: "text-center" },
            { name: 'tipo_empresa', data: null, className: "text-center" },
            { name: 'activo_empresa', data: 'activo_empresa', className: "text-center" },
