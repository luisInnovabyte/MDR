...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Estados de Elemento</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Mantenimiento de Estados de Elemento</h4>
            <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaEstadosElemento" title="Ayuda sobre el módulo">
                <i class="bi bi-question-circle text-primary" style="font-size: 1.3rem;"></i>
            </button>
        </div>
        <br>
        <!-- <div class="mt-2">
            <p class="mg-b-0">Tabla básica para el mantenimiento de estados de elemento</p>
        </div> -->
    </div><!-- d-flex -->
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <!-- Botón Nuevo Estado de Elemento -->
                <a href="formularioEstadoElemento.php?modo=nuevo" class="btn btn-oblong btn-outline-primary flex-shrink-0 mt-2 mt-sm-0">
                    <i class="fas fa-plus-circle me-2"></i>Nuevo Estado de Elemento 
                </a>
            </div>

                     <!-- Tabla de estados de elemento -->
            <div class="table-wrapper">
                <table id="estados_elemento_data" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Id estado</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>
                                <select class="form-control form-control-sm" title="Filtrar por permite alquiler">
                                    <option value="">Todos</option>
                                    <option value="1">Sí permite</option>
...
<!-- *************************************** -->
    ...
    <?php include_once('ayudaEstadosElemento.php') ?>
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="mntEstadoElemento.js"></script>
