$(document).ready(function () {
    ...
    //     FORMATEO DE CAMPOS          //
    ///////////////////////////////////
    // FormValidator removido - ahora se maneja en formularioTipodocumento.js
    /////////////////////////////////////////
    ...
    /////////////////////////////////////
    // INICIO DE LA TABLA DE TIPOS DE DOCUMENTO //
    //         DATATABLES             //
    ///////////////////////////////////
    var datatable_tiposdocumentoConfig = {
        ...
        columns: [
            ...
            { name: 'id_tipo_documento', data: 'id_tipo_documento', visible: false, className: "text-center" }, // Columna 1: ID_TIPO_DOCUMENTO
            { name: 'codigo_tipo_documento', data: 'codigo_tipo_documento', className: "text-center align-middle" }, // Columna 2: CODIGO_TIPO_DOCUMENTO
            { name: 'nombre_tipo_documento', data: 'nombre_tipo_documento', className: "text-center align-middle" }, // Columna 3: NOMBRE_TIPO_DOCUMENTO
            
            { name: 'activo_tipo_documento', data: 'activo_tipo_documento', className: "text-center align-middle" }, // Columna 4: ESTADO
        ...
        columnDefs: [
            ...
            // Columna 1: id_tipo_documento 
            { targets: "id_tipo_documento:name", width: '5%', searchable: false, orderable: false, className: "text-center" },
            // Columna 2: codigo_tipo_documento
            { targets: "codigo_tipo_documento:name", width: '15%', searchable: true, orderable: true, className: "text-center" },
            // Columna 3: nombre_tipo_documento
            { targets: "nombre_tipo_documento:name", width: '25%', searchable: true, orderable: true, className: "text-center" },
            // Columna 4: activo_tipo_documento (Estado)
            {
                targets: "activo_tipo_documento:name", width: '10%', orderable: true, searchable: true, className: "text-center",
                render: function (data, type, row) {
                    if (type === "display") {
                        return row.activo_tipo_documento == 1 ? '<i class="bi bi-check-circle text-success fa-2x"></i>' : '<i class="bi bi-x-circle text-danger fa-2x"></i>';
                    }
                    // Para filtro y ordenamiento, devolver 1 o 0 como string
                    if (type === "filter" || type === "sort") {
                        return row.activo_tipo_documento == 1 ? '1' : '0';
                    }
                    return row.activo_tipo_documento;
                }
            },
            ...
            {   
                ...
                render: function (data, type, row) {
                    ...
                    if (row.activo_tipo_documento == 1) {
                        // permito desactivar el tipo de documento
                        return `<button type="button" class="btn btn-danger btn-sm desacTipodocumento" data-bs-toggle="tooltip-primary" data-placement="top" title="Desactivar" data-original-title="Tooltip on top" 
                             data-id_tipo_documento="${row.id_tipo_documento}"> 
                             <i class="fa-solid fa-trash"></i>
                             </button>`;
                    } else {
                        // debo permitir activar de nuevo el tipo de documento
                        return `<button class="btn btn-success btn-sm activarTipodocumento" data-bs-toggle="tooltip-primary" data-placement="top" title="Activar" data-original-title="Tooltip on top" 
                             data-id_tipo_documento="${row.id_tipo_documento}">
            ...
            // Columna 6: BOTON PARA EDITAR TIPO DE DOCUMENTO
            {   
                targets: "editar:name", width: '10%', searchable: false, orderable: false, class: "text-center",
                render: function (data, type, row) {
                    // El nombre que de la variable que se pasa por data-xxx debe ser el mismo que el nombre de la columna en la base de datos
                    // botón editar el tipo de documento
                    return `<button type="button" class="btn btn-info btn-sm editarTipodocumento" data-toggle="tooltip-primary" data-placement="top" title="Editar"  
                             data-id_tipo_documento="${row.id_tipo_documento}"> 
        ...
        ajax: {
            url: '../../controller/tipodocumento.php?op=listar',
            type: 'GET',
    ...
    }; // de la variable datatable_tiposdocumentoConfig
    ////////////////////////////
    // FIN DE LA TABLA DE TIPOS DE DOCUMENTO //
    ///////////////////////////
    ...
    /**********************************/
    // Definición inicial de la tabla de tipos de documento
    var $table = $('#tiposdocumento_data');  /*<--- Es el nombre que le hemos dado a la tabla en HTML */
    var $tableConfig = datatable_tiposdocumentoConfig; /*<--- Es el nombre que le hemos dado a la declaración de la definicion de la tabla */
    var $tableBody = $('#tiposdocumento_data tbody'); /*<--- Es el nombre que le hemos dado al cuerpo de la tabla en HTML */
    /* en el tableBody solo cambiar el nombre de la tabla que encontraremos en HTML*/
    var $columnFilterInputs = $('#tiposdocumento_data tfoot input, #tiposdocumento_data tfoot select'); /*<--- Selecciona tanto inputs como selects de los pies de la tabla en HTML */
    /* en el $columnFilterInputs solo cambiar el nombre de la tabla que encontraremos en HTML*/

    //ejemplo -- var table_e = $('#tiposdocumento-table').DataTable(datatable_tiposdocumentoConfig);
            ...
            <div class="card border-primary mb-3" style="overflow: visible;">
                <div class="card-header bg-primary text-white">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="card-title mb-0">Detalles del Tipo de Documento</h5>
                    </div>
                </div>
                        ...
                        <tbody>
                            <tr>
                                <th scope="row" class="ps-4 w-25 align-top">
                                    <i class="bi bi-hash me-2"></i>Id Tipo Documento
                                </th>
                                <td class="pe-4">
                                    ${d.id_tipo_documento || '<span class="text-muted fst-italic">No tiene id tipo documento</span>'}
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="ps-4 w-25 align-top">
                                    <i class="bi bi-tag me-2"></i>Código Tipo Documento
                                </th>
                                <td class="pe-4">
                                    ${d.codigo_tipo_documento || '<span class="text-muted fst-italic">No tiene código</span>'}
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="ps-4 w-25 align-top">
                                    <i class="bi bi-file-text me-2"></i>Nombre Tipo Documento
                                </th>
                                <td class="pe-4">
                                    ${d.nombre_tipo_documento || '<span class="text-muted fst-italic">No tiene nombre</span>'}
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="ps-4 w-25 align-top">
                                ...
                                <td class="pe-4" style="max-width: 300px; word-wrap: break-word; white-space: pre-wrap; overflow-wrap: break-word;">
                                    ${d.descripcion_tipo_documento || '<span class="text-muted fst-italic">No tiene descripción</span>'}
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="ps-4 w-25 align-top">
                                    <i class="bi bi-calendar-plus me-2"></i>Tipo de documento creado el:
                                </th>
                                <td class="pe-4">
                                    ${d.created_at_tipo_documento ? formatoFechaEuropeo(d.created_at_tipo_documento) : '<span class="text-muted fst-italic">Sin fecha</span>'}
                                </td>
                            </tr>
                            <tr>
                                <th scope="row" class="ps-4 w-25 align-top">
                                    <i class="bi bi-calendar-plus me-2"></i>Tipo de documento actualizado el:
                                </th>
                                <td class="pe-4">
                                  ${d.updated_at_tipo_documento ? formatoFechaEuropeo(d.updated_at_tipo_documento) : '<span class="text-muted fst-italic">Sin fecha</span>'}
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    /////////////////////////////////////
    //   INICIO ZONA DELETE TIPOS DE DOCUMENTO  //
    ///////////////////////////////////
    function desacTipodocumento(id) {
        Swal.fire({
            title: 'Desactivar',
            html: `¿Desea desactivar el tipo de documento con ID ${id}?<br><br><small class="text-warning"><i class="bi bi-exclamation-triangle me-1"></i>Esto desactivará este tipo de documento en el sistema</small>`,
            icon: 'question',
            ...
            if (result.isConfirmed) {
                $.post("../../controller/tipodocumento.php?op=eliminar", { id_tipo_documento: id }, function (data) {

                    $table.DataTable().ajax.reload();

                    Swal.fire(
                        'Desactivado',
                        'El tipo de documento ha sido desactivado',
                        'success'
                    )
                });
            }
    ...
    $(document).on('click', '.desacTipodocumento', function (event) {
        event.preventDefault();
        let id = $(this).data('id_tipo_documento');
        desacTipodocumento(id);
    });
    ////////////////////////////////////
    //   FIN ZONA DELETE TIPO DE DOCUMENTO    //
    //////////////////////////////////

    ///////////////////////////////////////
    //   INICIO ZONA ACTIVAR TIPO DE DOCUMENTO  //
    /////////////////////////////////////
    function activarTipodocumento(id) {
        Swal.fire({
            title: 'Activar',
            text: `¿Desea activar el tipo de documento con ID ${id}?`,
            icon: 'question',
            showCancelButton: true,
            confirmButtonText: 'Si',
            cancelButtonText: 'No',
            ...
            if (result.isConfirmed) {
                $.post("../../controller/tipodocumento.php?op=activar", { id_tipo_documento: id }, function (data) {

                    $table.DataTable().ajax.reload();

                    Swal.fire(
                        'Activado',
                        'El tipo de documento ha sido activado',
                        'success'
                    )
                });
            }
    ...
    $(document).on('click', '.activarTipodocumento', function (event) {
        event.preventDefault();
        let id = $(this).data('id_tipo_documento');
        console.log("id tipo documento:",id);
        
        activarTipodocumento(id);
    });
    ////////////////////////////////////
    //   FIN ZONA ACTIVAR TIPO DE DOCUMENTO    //
    //////////////////////////////////
    ...
    $(document).on('click', '.editarTipodocumento', function (event) {
        event.preventDefault();
        ...
        window.location.href = `formularioTipodocumento.php?modo=editar&id=${id}`;
    });
    ///////////////////////////////////////
    //        FIN ZONA EDITAR           //
    /////////////////////////////////////
