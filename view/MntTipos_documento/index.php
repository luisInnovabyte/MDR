...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Tipos de Documento</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Mantenimiento de Tipos de Documento</h4>
            <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaTiposdocumento" title="Ayuda sobre el módulo">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <a href="formularioTipodocumento.php?modo=nuevo" class="btn btn-oblong btn-outline-primary flex-shrink-0 mt-2 mt-sm-0">
                    <i class="fas fa-plus-circle me-2"></i>Nuevo Tipo de Documento
                </a>
            </div>
                        ...
                        <h6 class="mg-b-0">
                            <a id="accordion-toggle" 
                               ...
                               style="text-decoration: none;">
                                <i class="fas fa-filter me-2"></i>Filtros de Tipos de Documento
                            </a>
                        </h6>
                    </div> -->
            ...
            <div class="table-wrapper">
                <table id="tiposdocumento_data" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th></th>
...
<!-- *************************************** -->
    ...
    <?php include_once('ayudaTiposdocumento.php') ?>
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="mnttipodocumento.js"></script>
