...
<div class="br-mainpanel">
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Mantenimiento Unidades</span>
        </nav>
    </div><!-- br-pageheader -->
    
    <div class="br-pagetitle">
        <div class="d-flex align-items-center">
            <h4 class="mb-0 me-2">Mantenimiento de Unidades de Medida</h4>
            <button type="button" class="btn btn-link p-0 ms-1" data-bs-toggle="modal" data-bs-target="#modalAyudaUnidades" title="Ayuda sobre el módulo">
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                ...
                <!-- Botón Nueva Unidad -->
                <a href="formularioUnidad.php?modo=nuevo" class="btn btn-oblong btn-outline-primary flex-shrink-0 mt-2 mt-sm-0">
                        ...
                        <h6 class="mg-b-0">
                            <a id="accordion-toggle" 
                               ...
                               style="text-decoration: none;">
                                <i class="fas fa-filter me-2"></i>Filtros de Unidades
                            </a>
                        </h6>
                    </div> -->
            ...
            <div class="table-wrapper">
                <table id="unidades_data" class="table display responsive nowrap">
                    <thead>
                        <tr>
                            <th></th>
                            <th>Id unidad</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" placeholder="Buscar nombre (en)" class="form-control form-control-sm" /></th>
                            <th><input type="text" placeholder="Buscar símbolo" class="form-control form-control-sm" /></th>
                            <th>
...
<!-- *************************************** -->
    ...
    <?php include_once('ayudaUnidades.php') ?>
    ...
    <!--     END mainJs.php        -->
    <!-- ------------------------- -->
    <script type="text/javascript" src="mntunidad.js"></script>
