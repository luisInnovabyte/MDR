...
btnEnviarConfirmacion.click(function() {
    ...
    $.post("../../controller/login.php?op=comprobarCorreo",{usu_correo:correo},function (data) {
...
btnConfirmarCodigo.click(function() {
    ...
    if (validado === true) {
        $.post("../../controller/login.php?op=getTokenByCorreo",{correoUsu:correoUsu},function (data) {

            data = JSON.parse(data);
            let token = data[0].tokenUsu;
...
function enviarCorreoValidacion(){
    ...
    $.post("../../controller/login.php?op=correoValidarCambioPass",{usu_correo:correo,numeroAleatorio:numeroAleatorio},function (data) {
        if(data == 1){
