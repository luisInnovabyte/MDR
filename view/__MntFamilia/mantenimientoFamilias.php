    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Gestión de Familias</h6>
            ...
            <div class="modal-body pd-25">
                <h4 class="lh-3 mg-b-20" id="mdltitulo">
                    <a href="#" class="tx-inverse hover-primary">Formulario de Familia</a>
                </h4>
                    ...
                    <div class="card mb-4 border-primary">
                        <div class="card-header bg-primary text-white">
                            <h5 class="mb-0 tx-bold">
                                <i class="fas fa-barcode me-2"></i>Código de la Familia
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row no-gutters">
                                ...
                                <div class="col-7 col-sm-9">
                                    ...
                                    <small class="form-text text-muted">Código único identificativo de la familia (máximo 20 caracteres)</small>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- SECCIÓN 2: Nombre de la Familia -->
                    <div class="card mb-4 border-success">
                        <div class="card-header bg-success text-white">
                            <h5 class="mb-0 tx-bold">
                                <i class="fas fa-tag me-2"></i>Nombre de la Familia
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row no-gutters">
                                ...
                                <div class="col-7 col-sm-9">
                                    ...
                                    <small class="form-text text-muted">Nombre descriptivo de la familia de productos (máximo 100 caracteres)</small>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row no-gutters">
                                ...
                                <div class="col-7 col-sm-9">
                                    ...
                                    <small class="form-text text-muted">Nombre de la familia de productos en inglés (máximo 100 caracteres)</small>
                                </div>
                            </div>
                        </div>
                    </div>

                    <!-- SECCIÓN 4: Descripción de la Familia -->
                    <div class="card mb-4 border-secondary">
                        <div class="card-header bg-secondary text-white">
                            <h5 class="mb-0 tx-bold">
                                <i class="fas fa-file-alt me-2"></i>Descripción de la Familia
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row no-gutters">
                                ...
                                <div class="col-7 col-sm-9">
                                    <textarea class="form-control" name="descr_familia" id="descr_familia" maxlength="255" rows="4" placeholder="Descripción detallada de la familia de productos..."></textarea>
            ...
            <div class="modal-footer">
                <button type="button" name="action" id="btnSalvarFamilia" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const activoSwitch = document.getElementById('activo_familia');
    ...
    if (activoSwitch && estadoText) {
        activoSwitch.addEventListener('change', function() {
            if (this.checked) {
                estadoText.textContent = 'Familia Activa';
                estadoText.className = 'text-success fw-bold';
            } else {
                estadoText.textContent = 'Familia Inactiva';
