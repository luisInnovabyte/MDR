$(document).ready(function () {
    ...
    $(document).on('click', '#btnSalvarFamilia', function (event) {
        ...
        verificarFamiliaExistente(id_familiaR, codigo_familiaR, name_familiaR, nombre_familiaR, descr_familiaR, activo_familiaR);
    });

    function verificarFamiliaExistente(id_familia, codigo_familia, name_familia, nombre_familia, descr_familia, activo_familia) {
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.existe) {
                    ...
                    guardarFamilia(id_familia, codigo_familia, name_familia, nombre_familia, descr_familia, activo_familia);
                }
            },
            error: function(xhr, status, error) {
    ...
    function guardarFamilia(id_familia, codigo_familia, name_familia, nombre_familia, descr_familia, activo_familia) {
