...
switch ($_GET["op"]) {
    ...
    case "cli_eng":
        try {
            ...
            // Allow discounts on lines (controls %Disc column and footer rows)
            ...
            // Subtotal (before discounts) — only if discounts are allowed
            if ($permitir_descuentos) {
            ...
            // Discount (only if there is one and discounts are allowed)
