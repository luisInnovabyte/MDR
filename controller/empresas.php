    ...
    case "listar":
        ...
        foreach ($datos as $row) {
            $data[] = array(
                ...
                "dias_validez_presupuesto_empresa" => $row["dias_validez_presupuesto_empresa"],
        ...
        try {
            if (empty($_POST["id_empresa"])) {
                $resultado = $empresa->insert_empresa(
                    ...
                    intval($_POST["empresa_ficticia_principal"] ?? 0),
                    $_POST["nif_empresa"],
                    ...
                    $_POST["serie_factura_proforma_empresa"],
                    $_POST["numero_actual_factura_proforma_empresa"],
                    $_POST["serie_factura_empresa"],
                    $_POST["numero_actual_factura_empresa"],
                    $_POST["serie_abono_empresa"],
                    $_POST["numero_actual_abono_empresa"],
                    $_POST["serie_abono_factura_proforma_empresa"] ?? 'RP',
                    intval($_POST["numero_actual_abono_factura_proforma_empresa"] ?? 0),
